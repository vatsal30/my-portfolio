...
export function Footer() {
    ...
    return (
        <footer className="w-full mt-24 border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 pb-24 md:pb-0">
            <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 py-4 text-xs font-mono text-zinc-500 dark:text-zinc-400">
